...
// The closure allows nested functions to go outside to the parent function and pull objects into the child inheritance.
  ...
  */
   ...
   function animalNames(zooAnimals){
      ...
      zooAnimals.forEach((el) => {
         newArray.push(`name: ${el.animal_name}, scientific: ${el.scientific_name}`)
      });
      return newArray;
   }
